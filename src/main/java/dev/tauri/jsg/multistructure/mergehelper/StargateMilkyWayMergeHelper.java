...
public class StargateMilkyWayMergeHelper extends StargateClassicMergeHelper {
    ...
    public StargateMilkyWayMergeHelper(StargateAbstractBaseBE tileEntity) {
        super(tileEntity);
    }

    @Override
    public Block getRingBlock() {
        return JSGBlocks.STARGATE_MILKYWAY_RING_BLOCK.get();
    }

    @Override
    public Block getChevronBlock() {
        return JSGBlocks.STARGATE_MILKYWAY_CHEVRON_BLOCK.get();
    }
}
