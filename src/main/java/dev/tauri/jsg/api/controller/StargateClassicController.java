...
public class StargateClassicController extends StargateAbstractController {
    ...
    public JSGConfigOption getGateConfigOption(String name) {
        return getStargate().getConfig().getOption(StargateClassicBaseBE.ConfigOptions.valueOf(name.toUpperCase()).id);
    }
    ...
    public boolean openTargetIris() {
        StargateAbstractBaseBE t = getTargetGateTile();
        if (t == null) return false;
        if (!(t instanceof StargateClassicBaseBE c)) return false;
