...
public class StargateMilkyWayController extends StargateClassicController {
    protected StargateMilkyWayController(StargateMilkyWayBaseBE tile) {
        super(tile);
    }
     ...
     * @return controller
     */
    public static StargateMilkyWayController getController(@Nonnull StargateMilkyWayBaseBE gateTile) {
