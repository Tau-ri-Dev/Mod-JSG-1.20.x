...
public class StargateClassicOCMethods extends StargateAbstractOCMethods<StargateClassicBaseBE<?>> {
    ...
    @SuppressWarnings("unused")
    @Callback(value = "sendMessage")
    public final Object[] sendMessage(Context context, Arguments args) {
        ...
        var msg = Optional.ofNullable(args.optString(0, null));
    ...
    @SuppressWarnings("unused")
    @Callback(value = "sendMessageToIncomingTraveller")
    public final Object[] sendMessageToIncomingTraveller(Context context, Arguments args) {
        if (!deviceTile.isMerged())
            return new Object[]{false, "stargate_failure_not_merged", "Stargate is not merged"};
        if (!deviceTile.getDialingManager().getStargateState().engaged())
            return new Object[]{false, "stargate_failure_not_engaged", "Stargate is not engaged"};
    ...
    @SuppressWarnings("unused")
    @Callback(value = "sendIrisCode")
    public final Object[] sendIrisCode(Context context, Arguments args) {
        var code = args.checkString(0);
    ...
    @SuppressWarnings("unused")
    @Callback(value = "engageSymbol")
    public final Object[] engageSymbol(Context context, Arguments args) {
        if (!deviceTile.isMerged())
            return new Object[]{false, "stargate_failure_not_merged", "Stargate is not merged"};
    ...
    @SuppressWarnings("unused")
    @Callback(value = "dialAddress")
    public final Object[] dialAddress(Context context, Arguments args) {
        if (!deviceTile.isMerged())
            return new Object[]{false, "stargate_failure_not_merged", "Stargate is not merged"};
        ...
        for (int i = 0; i < args.count(); i++) {
            argsParsed.add(args.checkAny(i));
        }
        if (args.count() > 0 && args.optTable(0, null) != null) {
    ...
    @SuppressWarnings("unused")
    @Callback(value = "spinRing")
    public final Object[] spinRing(Context context, Arguments args) {
        if (!deviceTile.isMerged())
        ...
        var direction = (args.optBoolean(0, false) ? EnumSpinDirection.COUNTER_CLOCKWISE : EnumSpinDirection.CLOCKWISE);
    ...
    @SuppressWarnings("unused")
    @Callback(value = "engageTopSymbol")
    public final Object[] engageTopSymbol(Context context, Arguments args) {
        if (!deviceTile.isMerged())
            return new Object[]{false, "stargate_not_merged", "Stargate must be merged!"};
        var state = deviceTile.getDialingManager().getStargateState();
        if (!state.idle())
    ...
    @SuppressWarnings("unused")
    @Callback(value = "openChevron")
    public final Object[] openChevron(Context context, Arguments args) {
        if (!deviceTile.isMerged())
            return new Object[]{false, "stargate_not_merged", "Stargate must be merged!"};
        var state = deviceTile.getDialingManager().getStargateState();
        if (!state.idle())
            return new Object[]{false, "stargate_busy", "Stargate must be idle!"};
        var chevron = (Optional.ofNullable(args.isInteger(0) ? args.checkInteger(0) : null).map(ChevronEnum::valueOf).orElse(deviceTile.getDialingManager().getNextChevron(deviceTile.getDialingManager().getSpinHelper().getCurrentTopSymbol(), false, false)));
    ...
    @SuppressWarnings("unused")
    @Callback(value = "closeChevron")
    public final Object[] closeChevron(Context context, Arguments args) {
        if (!deviceTile.isMerged())
            return new Object[]{false, "stargate_not_merged", "Stargate must be merged!"};
        var state = deviceTile.getDialingManager().getStargateState();
        if (!state.idle())
    ...
    @SuppressWarnings("unused")
    @Callback(value = "getChevronStatus")
    public final Object[] getChevronStatus(Context context, Arguments args) {
        if (!deviceTile.isMerged())
            return new Object[]{false, "stargate_not_merged"};
        var chevron = Optional.ofNullable(args.isInteger(0) ? args.checkInteger(0) : null).flatMap(i -> Optional.ofNullable(ChevronEnum.valueOf(i)));
        if (chevron.isEmpty())
    ...
    @SuppressWarnings("unused")
    @Callback(value = "activateChevron")
    public final Object[] activateChevron(Context context, Arguments args) {
        if (!deviceTile.isMerged())
            return new Object[]{false, "stargate_not_merged", "Stargate must be merged!"};
        var state = deviceTile.getDialingManager().getStargateState();
        if (!state.idle())
    ...
    @SuppressWarnings("unused")
    @Callback(value = "deactivateChevron")
    public final Object[] deactivateChevron(Context context, Arguments args) {
        if (!deviceTile.isMerged())
            return new Object[]{false, "stargate_not_merged", "Stargate must be merged!"};
        var state = deviceTile.getDialingManager().getStargateState();
        if (!state.idle())
    ...
    @Callback(value = "getCapacitorsInstalled", doc = "DEPRECATED; use getEnergyCrystalsInstalled() instead")
    public final Object[] getCapacitorsInstalled(Context context, Arguments args) {
        return new Object[]{deviceTile.isMerged() ? deviceTile.currentPowerTier - 1 : null};
    }

    @SuppressWarnings("unused")
    @Callback(value = "getEnergyCrystalsInstalled")
    public final Object[] getEnergyCrystalsInstalled(Context context, Arguments args) {
        return new Object[]{deviceTile.isMerged() ? deviceTile.currentPowerTier - 1 : null};
    }

    @SuppressWarnings("unused")
    @Callback(value = "getNearbyGates")
    public final Object[] getNearbyGates(Context context, Arguments args) {
        if (!deviceTile.isMerged())
            return new Object[]{false, "gate_not_merged", new HashMap<String, Object>()};

        var gateTypeString = args.checkString(0);
        var ignoreGateType = args.checkBoolean(1);
        var checkAddressAndEnergy = args.checkBoolean(2);
